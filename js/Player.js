export default class Player extends Phaser.Physics.Matter.Sprite{
    ...
    static preload(scene){
        scene.load.atlas('female-player', 'assets/images/female-player.png', 'assets/images/female-player_atlas.json');
        scene.load.animation('female_anim', 'assets/images/female-player_anim.json');
    }
